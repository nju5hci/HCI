   ...
   <!------------End Header ------------>
    ...
    <div class="component">
		<table>
			...
			%>
				<tr><td><%=dessert_id[i] %></td><td><%=dessert_name[i] %></td><td><%=dessert_price[i] %></td><td ><%=dessert_num[i] %></td><td><%=date[i] %></td><td><a href="/DessertHouse/addAssess?plan_id=<%=reserve_id[i]%>&&allow=2">评价</a></td></tr>
			<%
			   }%>
