    ...
    <div class="main">
     ...
     <div class="content">
     	<div class="content_top">
    		...
    		<p><a href="/DessertHouse/assessActivity">评价已买货物就会有50积分想送哦~</a> &gt;&gt;&gt; </p>
    	    </div>
    		<div class="clear"></div>
    	</div>
    <div class="component">
		<table>
			...
			%>
				<tr><td><%=dessert_id[i] %></td><td><%=dessert_name[i] %></td><td><%=dessert_price[i] %></td><td ><%=dessert_num[i] %></td><td><%=date[i] %></td><td><a href="/DessertHouse/allowandalterActivity?plan_id=<%=reserve_id[i]%>&&allow=2">确认出票</a></td><td><a href="/DessertHouse/allowandalterActivity?plan_id=<%=reserve_id[i]%>&&allow=4">退出活动</a></td></tr>
			<%
			   }%>
