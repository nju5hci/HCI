								  ...
								  <div class="slider">
							      	<div class="slider-wrapper theme-default">
							            <div id="slider" class="nivoSlider">
							                <img src="../images/11.jpg" data-thumb="images/11.jpg" alt="" />
							                <img src="../images/22.jpg" data-thumb="images/22.jpg" alt="" />
							                <img src="../images/33.jpg" data-thumb="images/33.jpg" alt="" />
							                <img src="../images/44.jpg" data-thumb="images/44.jpg" alt="" />
							                 <img src="../images/55.jpg" data-thumb="images/55.jpg" alt="" />
							            </div>
							        </div>
						   		</div>
						<!------End Slider ------------>
      ...
      <div class="content">
					...
					<div class="price-details">
				       <div class="price-number">
							<p><span class="rupees"><%=money_soil[i] %></span></p>
					       		...
					       		<div class="add-cart">								
								<form action="/DessertHouse/deleteSoil" method="post">	
					       		<input class='a'  type="text" name="dessertid" value= <%=id_soil[i] %>>
							<div class="submit">
							<input name ="manage"type="submit" value="设为已租" >
	   ...
	   <!-- Contact Form -->
                    <div class="contact-form">
                        <h3 class="main-heading"><span>添加土地</span></h3>
                        <div id="contact-status"></div>
                        <form action="/DessertHouse/addSoil" method="post" id="contactform">
                            <p>
                            	<label for="name">土地id</label>
                            	<input type="text" name="dessertId" class="input" >
                            </p>
                            <p>
                            	<label for="email">土地所在地</label>
                            	<input type="text" name="dessertName" class="input">
                            </p>
                            
                             <p>
                            	<label for="email">土地简介</label>
                            	<input type="text" name="dessertInfo" class="input">
                            </p>
                             <p>
                            	<label for="email">土地金额</label>
